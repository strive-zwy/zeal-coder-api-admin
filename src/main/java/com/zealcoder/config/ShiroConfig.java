...
import com.zealcoder.shiroJWT.JwtFilter;
import com.zealcoder.shiroJWT.MyRealm;
...
//        ruleMap.put("/user/register", "anon");
        ruleMap.put("/comment/insert", "jwt");
        ruleMap.put("/**", "anon");  // /**，一般放在最下，表示对所有资源起作用，使用JwtFilter
